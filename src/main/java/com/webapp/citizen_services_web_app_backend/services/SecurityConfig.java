    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/complaints/**").hasAnyAuthority("ROLE_CITIZEN", "ROLE_ADMIN")  // ← explicit ROLE_ prefix – this should match your filter
                        .anyRequest().authenticated()
                )
                .exceptionHandling(ex -> ex
                        .accessDeniedHandler(accessDeniedHandler())  // ← JSON on 403 so frontend can read it
                );
