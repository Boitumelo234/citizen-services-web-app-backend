...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> getOverviewStats() {
        ...
        // Use Boolean.TRUE.equals() — safe for wrapper Boolean
    ...
    private Map<String, Object> toComplaintMap(Complaint c) {
        ...
        if (c.getAssignedTo() != null) {
            m.put("assignedToId", c.getAssignedTo().getId());
            m.put("assignedToName", c.getAssignedTo().getFullName() != null
                    ? c.getAssignedTo().getFullName() : c.getAssignedTo().getEmail());
        }
    ...
    private Map<String, Object> toUserMap(User u) {
        ...
        // Use getActive() — wrapper Boolean generates getActive(), not isActive()
